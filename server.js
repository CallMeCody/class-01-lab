...
// after the request is made, we run the request object through out "stamper" and
...
app.use(errorHandler); // your error handler should always be the last route in your server
